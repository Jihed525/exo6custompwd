...
public class CustomPasswordRecoveryServiceImpl extends PasswordRecoveryServiceImpl {
    ...
    public CustomPasswordRecoveryServiceImpl(InitParams initParams, OrganizationService orgService, MailService mailService,
        ...
        super(initParams, orgService, mailService, bundleService, remindPasswordTokenService, controller, brandingService);
